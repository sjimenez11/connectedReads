...
VALUES(uuid(), 8417854312, 'De sangre y cenizas', 'Jennifer L. Armentrout', 18.95, 'Fantasía romántica', 'UNA DONCELLA. Elegida desde su nacimiento para dar comienzo a una nueva era, la vida de Poppy nunca le ha pertenecido. La vida de la Doncella es solitaria. Jamás la tocarán. Jamás la mirarán. Jamás le hablarán. Jamás sentirá placer.', 33, NOW()-2, NOW()-1);

INSERT INTO libro (uuid, ISBN, titulo, autor, precio, genero, sinopsis, stock, created_at, updated_at)
VALUES(uuid(), 8419266280, 'Babel', 'Rebecca F. Kuang', 20.90, 'Narrativa fantástica', '1828. El Instituto Real de Traducción de Oxford, también conocido como Babel, es la institución mágica más importante del mundo. La magia con plata capaz de revelar significados ocultos perdidos en la traducción que allí se practica...', 19, NOW()-2, NOW()-1);
